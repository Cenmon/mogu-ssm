...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld"><a href="/" hidefocus="true" clstag="homepage|keycount|home2013|02a"><b></b><img src="/images/logo.jpg" width="270" height="60" alt="蘑菇"></a></div>
		<!--logo end-->
		<div id="search-2013">
	...
	<div class="w">
		<div id="nav-2013">
			...
			<div id="treasure" clstag="homepage|keycount|home2013|08a"></div>
				<ul id="navitems-2013">
					<li class="fore1" id="nav-home" width="80px"><a href="/">首页</a></li>
					<li class="fore2" id="nav-fashion" width="80px"><a href="">蘑菇精选</a></li>
					<li class="fore3" id="nav-chaoshi" width="80px"><a href="">蘑菇旅行</a></li>
					<li class="fore4" id="nav-tuan" width="80px"><a href="" target="_blank">智能生活</a></li>
					<li class="fore5" id="nav-auction" width="80px"><a href="">蘑菇秒杀</a></li>
					<li class="fore6" id="nav-shan" width="80px"><a href="" target="_blank">蘑菇好货</a></li>
				</ul>
		</div>
	</div>
</div>
