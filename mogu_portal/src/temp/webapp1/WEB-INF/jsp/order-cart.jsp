...
<div class="w w1 header clearfix">
    <div id="logo" ><a href="/"><img src="/images/logo.jpg" alt="蘑菇商城" width="100px" height="100px"></a></div>
</div>
<!-- method="post" -->
<form id="orderForm" class="hide" action="/success.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="成都信息工程大学"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="15666666666"/>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="10">张三</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">15666666666</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">四川 成都 双流区</div>
...
<div class="shopping-list ABTest">
	<div class="goods-list">
     <!--配送方式-->
    <h4 class="vendor_name_h" id="0">商家：蘑菇商城</h4>		         
		...
		<div class="mode-tab-nav">
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					...
					id="jdShip-span-tip" class="m-txt">蘑菇快递<i
						class='qmark-icon qmark-tip'
						data-tips='由本人负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b></li>
			</ul>
		</div>
	</div>
</div>
