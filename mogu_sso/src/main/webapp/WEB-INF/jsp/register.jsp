...
<head>
    ...
    <title>注册-个人用户</title>
    <link rel="icon" href="/images/mogu-icon.png" sizes="32x32">
...
<div class="w" id="logo">
    <div>
    	<a href="http://localhost:8083">
    		<img src="/images/mogu-logo.png" alt="蘑菇商城" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
            ...
            <div class="form" onselectstart="return false;">
					...
					<div class="item" id="dphone">
						...
						<div class="fl item-ifo">
							<input type="text" id="phone" maxlength="11" name="phone" class="text" tabindex="4" 
									autocomplete="off" request pattern = "^1[3456789]\d{9}$" 
                ...
                <div class="item item-new">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《蘑菇用户注册协议》</a></label>
                        <span class="clr"></span>
